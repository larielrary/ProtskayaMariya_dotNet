<<<<<<< HEAD:ServiceStation/BusinessLayer/ServiceStationService/OwnersService.cs
﻿using AutoMapper;
...
namespace BusinessLayer.ServiceStationService
{
    public class OwnerService : IEntityService<Owner>
    {
        ...
        public OwnerService(IRepository<OwnerDTO> ownerRepository, IMapper mapper)
        {
            _ownerRepository = ownerRepository;
            _mapper = mapper;
        }
...
>>>>>>> f206825b397cc5bcfb3f9465643c3c8f2f796e57:ServiceStation/BusinessLayer/ServiceStationService/OwnerService.cs
